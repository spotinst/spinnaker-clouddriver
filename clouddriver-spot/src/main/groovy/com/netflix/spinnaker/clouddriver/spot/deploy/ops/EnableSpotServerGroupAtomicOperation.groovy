...
class EnableSpotServerGroupAtomicOperation extends AbstractEnableDisableAtomicOperation {

  final String phaseName = "ENABLE_SERVER_GROUP"

  EnableSpotServerGroupAtomicOperation(EnableDisableSpotServerGroupDescription description) {
    super(description)
  }
