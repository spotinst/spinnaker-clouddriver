...
class TerminateInstanceAndDecrementServerGroupAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  AtomicOperation convertOperation(Map input) {
    new TerminateInstanceAndDecrementServerGroupAtomicOperation(convertDescription(input))
  }

  @Override
  TerminateInstanceAndDecrementServerGroupDescription convertDescription(Map input) {
    def converted = objectMapper.convertValue(input, TerminateInstanceAndDecrementServerGroupDescription)
