...
class DisableSpotServerGroupAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  @Override
  EnableDisableSpotServerGroupDescription convertDescription(Map input) {
    def converted = objectMapper.convertValue(input, EnableDisableSpotServerGroupDescription)
