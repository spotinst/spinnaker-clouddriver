...
class DisableSpotServerGroupAtomicOperation extends AbstractEnableDisableAtomicOperation {

  final String phaseName = "DISABLE_SERVER_GROUP"

  DisableSpotServerGroupAtomicOperation(EnableDisableSpotServerGroupDescription description) {
    super(description)
  }
